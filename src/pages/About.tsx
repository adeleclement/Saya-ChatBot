        ...
        <section className="py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="container max-w-6xl mx-auto px-4">
            <motion.div 
              ...
              variants={fadeIn}
            >
              <h1 className="text-4xl md:text-5xl font-display font-bold text-lumi-purple-dark mb-6">
                About Lumi
              </h1>
            ...
            >
              <div className="order-2 md:order-1">
                ...
                <p className="text-lumi-gray-dark mb-4">
                  Lumi was created with a simple yet powerful mission: to provide women with a safe, judgment-free space to explore health topics, find reliable information, and receive personalized guidance.
                </p>
                ...
                <Button 
                  className="rounded-full bg-gradient-to-br from-lumi-purple to-lumi-purple-dark text-white hover:opacity-90 transition-all shadow-md hover:shadow-lg flex gap-2 items-center"
